...
1.  [<code>[1/2]</code> Prototyping](#orgc5d6267)
    1.  [Features](#orga69dd5a)
    2.  [<code>[1/3]</code> Wireframe](#org9d97d9f)
        1.  [World map](#org863b822)
        2.  [Sub region pop-up](#orgaec6fa5)
        3.  [World figures](#orga615f17)
2.  [Dataset](#org1a5054a)
    1.  [Variables](#org72a6d0d)
    2.  [Data sources](#org6a652b8)
        1.  [`Decade`](#org6c4bd7a)
        2.  [`UN_Geosheme_Subregion`](#orge1b76fb)
        3.  [`Disaster_Type`](#orgf63e118)
        4.  [`RCP`](#org022f7fa)
        5.  [`DO`](#org7d9f320)
        6.  [`Human_Impact`](#orgb63d500)
        7.  [`Financial_Impact`](#orga51b13a)
        8.  [`°C`](#orgc9e808c)
        9.  [`Geo`](#org806b698)
3.  [<code>[3/4]</code> Development](#org4af03ba)
    1.  [Why did we pick Dash?](#orgd722c9d)
    2.  [Architecture](#org64a6987)
        1.  [`app.py`](#orgc352c01)
        2.  [`assets/style.css`](#org87de5b2)
        3.  [`assets/WB_logo.jpg`](#org97b03e1)
    3.  [Visual identity guidelines](#org043644b)
        1.  [Colors](#org7dab486)
            -   [Primary colors](#org305bf03)
            -   [Secondary colors](#org9b18ab3)
        2.  [Fonts](#orgdc16a86)
            -   [Primary fonts](#orgbe07a9b)
            -   [Secondary fonts](#org814702c)
        3.  [Logo](#orgfe7616c)
            -   [Symbol](#org8e10994)
            -   [Logotype](#orgfa2a164)
    4.  [How to contribute](#org1bee1d7)
        1.  [Setting up a new Git repository](#org79ffeb0)
        2.  [Adding or modifying owned files (`push`)](#orgcc24a73)
        3.  [Submit proposed changes to review](#org06d60ee)
        4.  [Adding reviewed files (`merge`)](#orgbeb1414)
4.  [Tools that we used](#org531b7d4)
