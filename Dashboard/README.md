...
1.  [<code>[1/2]</code> Prototyping](#orgf3d1220)
    1.  [Features](#org3f8c4e1)
    2.  [<code>[1/3]</code> Wireframe](#orgf2aac9b)
        1.  [World map](#org1c8745f)
        2.  [Sub region pop-up](#orga878c7c)
        3.  [World figures](#orgccd7d48)
2.  [Dataset](#orge799847)
    1.  [Variables](#orgb3ddb65)
    2.  [Data sources](#orgab8bd5c)
        1.  [`Decade`](#org3b4ef5b)
        2.  [`UN_Geosheme_Subregion`](#org456b15d)
        3.  [`Disaster_Type`](#org7d141aa)
        4.  [`RCP`](#orgaeae630)
        5.  [`DO`](#orgca55b9a)
        6.  [`Human_Impact`](#org2cc0f1f)
        7.  [`Financial_Impact`](#orgc58e6c7)
        8.  [`°C`](#orgb6e938d)
        9.  [`Geo`](#orgd6d31e8)
3.  [<code>[3/4]</code> Development](#org1c16f0d)
    1.  [Why did we pick Dash?](#orgd02fda4)
    2.  [Architecture](#org49c8923)
        1.  [`app.py`](#org70211cf)
        2.  [`assets/style.css`](#org5910e8a)
        3.  [`assets/WB_logo.jpg`](#orga9ae4c5)
    3.  [Visual identity guidelines](#org29c80d9)
        1.  [Colors](#org454ce2d)
            -   [Primary colors](#org948e32f)
            -   [Secondary colors](#org1a7cfe4)
        2.  [Fonts](#org69baf41)
            -   [Primary fonts](#org36d15ae)
            -   [Secondary fonts](#orgef15951)
        3.  [Logo](#org6059efe)
            -   [Symbol](#orgfff0c30)
            -   [Logotype](#orgb467efe)
    4.  [How to contribute](#org91ccbc6)
        1.  [Setting up a new Git repository](#org65045a6)
        2.  [Adding or modifying owned files (`push`)](#orgdf7e2b6)
        3.  [Submit proposed changes to review](#org7fd86eb)
        4.  [Adding reviewed files (`merge`)](#org3c39fcb)
4.  [Tools that we used](#orgef336cf)
