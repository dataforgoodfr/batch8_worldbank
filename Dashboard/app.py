                        ...
                        html.Div(
                            ...
                            children=[
                                ...
                                dcc.Graph(
                                    ...
                                    figure=display_map(df_map_data[(df_map_data['Decade'] == 1900) & (df_map_data['Disaster_Type']=='Droughts') & (df_map_data['RCP'] == 0)], 'Human_Impact','reds')
                                    ),
                            ],
                        ),
                    ],
...
def update_map(year,DisasterType,ImpactType):
    df_decade_disaster_temp = df_map_data[(df_map_data['Decade'] == year) & (df_map_data['Disaster_Type'] == DisasterType)]
    if ImpactType == False:
        color= "reds"
        type ='Human_Impact'
        ...
        #df_color = px.choropleth_mapbox(color_continuous_scale= colorimpact)
    return display_map(df_decade_disaster_temp, type, color)
